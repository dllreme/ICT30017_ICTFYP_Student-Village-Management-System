...
if (!isset($_SESSION['user']) || $_SESSION['role'] !== 'student') {
    header("Location: mainpage.php?error=Please login as student");
    exit;
}
...
<head>
    ...
    <title><?php echo $pageTitle ?? 'Swinburne Student Village - Student Dashboard'; ?></title>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-slider">
                ...
                <div class="slide">
                    <img src="img/ad1.jpeg" alt="Campus Facilities">
                </div>
                <div class="slide">
                    <img src="img/ad2.jpeg" alt="Student Life">
                </div>
                <div class="slide">
                    <img src="img/ad3.jpeg" alt="Accommodation">
                </div>
                <div class="slide">
                    <img src="img/ad4.jpeg" alt="Community Areas">
                </div>
